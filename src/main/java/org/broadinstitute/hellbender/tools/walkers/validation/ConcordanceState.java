...
interface InterfaceConcordanceState {
    ...
    public void addInVCF(MergeMutect2CallsWithMC3 merger, AbstractConcordanceWalker.TruthVersusEval truthVersusEval, final List<Genotype> genotypes); // find better name
}
    ...
    TRUE_POSITIVE("TP") {
        public void countInTP(EvaluateInfoFieldConcordance evaluateInfoFieldConcordance, AbstractConcordanceWalker.TruthVersusEval truthVersusEval) {
            if(truthVersusEval.getEval().isSNP()){
                evaluateInfoFieldConcordance.setSnpCount(evaluateInfoFieldConcordance.getSnpCount()+1); //snpCount++;
        ...
        public void addInVCF(MergeMutect2CallsWithMC3 merger, AbstractConcordanceWalker.TruthVersusEval truthVersusEval, final List<Genotype> genotypes) {
